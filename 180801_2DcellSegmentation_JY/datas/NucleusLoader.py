...
from datas.preprocess import random_flip2d
import warnings
...
class NSDataset(data.Dataset):
    ...
    def _2D_image(self, idx):
        ...
        input_np=input_np[:208,:208]
        target_np=data_pack['target']
        target_np=target_np[:208,:208]
        isMerged_np=data_pack['isMerged']
...
if __name__ == "__main__":
    # Test Data Loader
    f_path="/home/Jinyeop/PyCharmProjects_JY/180801_2DcellSegmentation_JY/data/Training_examples/total/test"
