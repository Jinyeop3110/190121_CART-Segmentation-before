...
if __name__ == "__main__":
    ...
    # filename example :
    f_path_train = "/data1/0000Deployed_JY/train_"
    f_path_valid = "/data1/0000Deployed_JY/valid_"
    #f_path_test = "/home/jysong/PyCharmProjects_JY/180907_3DcellSegmentation_regressionVer/data/test_"
    f_path_test="/data1/0000Deployed_JY/valid_"
    ...
    recon_loss=DiceDis(ratio1=1, gamma=2, pw=10, erode=2, is_weight=1)
    ...
    model.load(filename="epoch[0696]_losssum[0.016680].pth.tar")
    ...
    test_loader = nucleusloader(f_path_test, batch_size=1, transform=None,
                                ...
                                drop_last=True)
    model.test(test_loader,savedir='hardcase')