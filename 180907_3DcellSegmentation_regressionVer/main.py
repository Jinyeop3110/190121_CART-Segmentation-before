...
from models.unet_glob1006 import Unet3D_glob
...
if __name__ == "__main__":
    ...
    arg.save_dir = "nets_1004_unet_glob1006_disdice_FRE_pw10_erode2_feat1_trans32"
    ...
    # filename example :
    f_path_train="/data1/0000Deployed_JY/stest_"
    f_path_valid = "/data1/0000Deployed_JY/svalid_"
    f_path_test = "/data1/0000Deployed_JY/stest_"
    #f_path_test = "/home/jysong/PyCharmProjects_JY/180907_3DcellSegmentation_regressionVer/data/to256_hela_JY340"
    ...
    if arg.model == "fusion":
        ...
        net = Unet3D_glob(feature_scale=arg.feature_scale, trans_feature=32)
    ...
    recon_loss=DiceDis(ratio1=0, gamma=2, pw=10, erode=2, is_weight=1)
    val_loss=DiceDis(ratio1=1, is_weight=0)
    ...
    model.load(filename="epoch[0255]_losssum[0.118237].pth.tar")
    if arg.test==0:
        model.train(train_loader, valid_loader)
    if arg.test==1:
        model.test(test_loader,savedir='test')
